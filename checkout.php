   ...
   <div class="display-order">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <select name="method">
               <option value="cash on delivery" selected>Delivery</option>
               <option value="credit cart">Tarjeta de credito</option>
               <option value="paypal">PayPal</option>
            </select>
         </div>
         <div class="inputBox">
            <span>Colonia</span>
            <input type="text" placeholder="Introduce tu colonia" name="flat" required>
         </div>
         <div class="inputBox">
            <span>Calle</span>
            <input type="text" placeholder="Introduce tu calle" name="street" required>
         </div>
         <div class="inputBox">
            <span>Municipio</span>
            <input type="text" placeholder="Introduce tu municipio" name="city" required>
         </div>
         <div class="inputBox">
            <span>Estado</span>
            <input type="text" placeholder="Introduce tu estado" name="state" required>
         </div>
         <div class="inputBox">
            <span>Pais</span>
            <input type="text" placeholder="Introduce tu pais" name="country" required>
         </div>
         <div class="inputBox">
            <span>Codigo Postal</span>
            <input type="text" placeholder="Introduce tu codigo postal" name="pin_code" required>
         </div>
      </div>
